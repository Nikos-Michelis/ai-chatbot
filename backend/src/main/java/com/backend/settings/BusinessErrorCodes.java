...
public enum BusinessErrorCodes {
    ...
    WEATHER_API_ERROR(401, INTERNAL_SERVER_ERROR, "Opps! somthing went wrong with OpenWeather API, try again later."),
    GEMINI_API_ERROR(402, INTERNAL_SERVER_ERROR, "Opps! somthing went wrong with Gemini API try again later.");
